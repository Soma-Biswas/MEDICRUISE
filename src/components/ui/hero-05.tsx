...
export interface Hero05Props {
  ...
  landscapeAlt?: string
  /** CSS object-position for the image crop, e.g. 'center', 'right center', '75% 50%' */
    ...
    <div className="relative w-full overflow-hidden">
      ...
      >
        ...
        <img
          ...
          className="aspect-[2/1] max-h-[65vh] w-full object-cover outline outline-black/10 sm:aspect-[9/4] sm:max-h-[70vh] dark:outline-white/10 dark:brightness-[0.97] dark:saturate-[0.92]"
        />
      </div>
    </div>
  )
